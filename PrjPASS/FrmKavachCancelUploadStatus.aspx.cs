...
{
    public partial class FrmKavachCancelUploadStatus : System.Web.UI.Page
    {
        ...
        protected void btnGetPolicy_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection sqlCon = new SqlConnection(consString))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    cmd.CommandText = "dbo.PROC_KAVACH_POLICY_CANCEL_STATUS";
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        string _DownloadableProductFileName = "KAVACH_CANCEL_UPLOAD_DUMP_" + DateTime.Now.Day.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Year.ToString() + DateTime.Now.Minute.ToString() + DateTime.Now.Second.ToString() + ".xls";
                        ...
                        if (ExportDataTableToExcel(dt, "CANCEL_UPLOAD_DUMP", strfilename) == true)
                        {
