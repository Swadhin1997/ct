...
namespace PrjPASS
{
    public partial class FrmHDCPaymentDownload : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("FrmHDCPaymentDownload.aspx");
        }
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["cnPass"].ConnectionString))
                {
                    ...
                    File.AppendAllText(logFile, "Calling SP PROC_GET_HDC_PAYMENT_DETAILS_DOWNLOAD  " + DateTime.Now.ToString() + System.Environment.NewLine);
                    SqlCommand cmd = new SqlCommand("PROC_GET_HDC_PAYMENT_DETAILS_DOWNLOAD", con);
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        string _DownloadableProductFileName = "HDC_Payment_Process_" + DateTime.Now.Day.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Year.ToString() + DateTime.Now.Minute.ToString() + DateTime.Now.Second.ToString() + ".xls";
                        ...
                        if (ExportDataTableToExcel(dt, "HDC Payment Entry", strfilename) == true)
                        {
