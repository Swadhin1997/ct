...
namespace PrjPASS
{
    public partial class FrmHealthClaimsUploadStatus : System.Web.UI.Page
    {
        ...
        protected void btnGetPolicy_Click(object sender, EventArgs e)
        {
            try
            {
                if (ddlStatus.SelectedValue == "Claim Outstanding Register")
                {
                ...
                using (SqlConnection sqlCon = new SqlConnection(ConfigurationManager.ConnectionStrings["cnPASS"].ConnectionString))
                {
                    ...
                    {
                        cmd.CommandText = "dbo.PROC_GET_HEALTH_CLAIMS_DATA";
                        ...
                        cmd.Parameters.AddWithValue("@Status", ddlStatus.SelectedValue.Equals("0") ? null : ddlStatus.SelectedValue);
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            SqlCommand cmd1 = new SqlCommand("SELECT  * FROM TBL_HEALTH_CLAIMS_COLUMN_MAPPING_MASTER where bExcludeForUpload='N'", sqlCon);
        ...
        private bool ExportDataTableToExcel(System.Data.DataTable dataTable, string worksheetName, string saveAsLocation)
        {
            ...
            try
            {
                ...
                excelSheet.Cells[1, 1].Value = "Health Claims Uploaded Records Dump";
                ...
                {
                    filters += "Status - " + ddlStatus.SelectedValue + ", ";
                }
