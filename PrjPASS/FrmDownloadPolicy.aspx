<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/PASS.Master" CodeBehind="FrmDownloadPolicy.aspx.cs" Inherits="PrjPASS.FrmDownloadPolicy" %>
                                ...
                                <center>
                                    <div style="text-align: center">
                                        <asp:GridView ID="gvPolicyData" CssClass="mydatagrid" runat="server" AutoGenerateColumns="false"
                                            DataKeyNames="TXT_POLICY_NO_CHAR,TXT_EMAIL" OnRowCommand="gvPolicyData_RowCommand"
                                            PagerStyle-CssClass="pager" HeaderStyle-CssClass="header" RowStyle-CssClass="rows"
                                            OnPageIndexChanging="gvPolicyData_PageIndexChanging"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkDownload" Text="Download" CommandArgument='<%# Eval("TXT_POLICY_NO_CHAR") %>' runat="server" data-ProductName='<%# Eval("PRODUCTNAME") %>' data-Productcode='<%# Eval("NUM_PRODUCT_CODE") %>' data-ID='<%# Eval("TXT_EMAIL") %>' data-myData='<%# Eval("TXT_CUSTOMER_NAME") %>' OnClick="lnkDownload_Click"></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
