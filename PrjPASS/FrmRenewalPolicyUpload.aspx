<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/PASS.Master" CodeBehind="FrmRenewalPolicyUpload.aspx.cs" Inherits="ProjectPASS.FrmRenewalPolicyUpload" %>
    ...
    <div class="smart-wrap">
        <div class="smart-forms smart-container wrap-4">
            <div class="form-header header-blue">
                <h4><i class="fa fa-sign-in"></i>PASS - Renewal Policy Upload</h4>
