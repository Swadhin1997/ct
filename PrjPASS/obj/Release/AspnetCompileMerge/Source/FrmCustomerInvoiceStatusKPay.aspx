<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmCustomerInvoiceStatusKPay.aspx.cs" Inherits="PrjPASS.FrmCustomerInvoiceStatusKPay" %>
                        ...
                        <div class="abs-center" >
                            <div class="text-center mv-lg">
                                <div class="text-bold text-lg mb-lg" style="font-size: 5rem; font-family: Source Sans Pro, sans-serif; color: #ab9d7e; padding-bottom: 10px">
                                    <asp:Label ID="lblThankYouOrSorry" runat="server"></asp:Label>
                                </div>
                            ...
                            <br />
                                    ...
                                    <asp:Label runat="server" ID="lblKGITransactionId"  Text=""></asp:Label>
                                    <br />
                                    <strong>Payment Id: </strong>
                                    <asp:Label runat="server" ID="lblPAYUTransactionId"  Text=""></asp:Label>
                                    <br />
                                    <strong>Payment Status: </strong>
                                    <asp:Label runat="server" ID="lblPaymentStatus"  Text=""></asp:Label>
                                    <br />
                                    <strong>Transaction Amount: </strong>
                                    <asp:Label runat="server" ID="lblTransactionAmount"  Text=""></asp:Label>
                                    <br />
                                    ...
                                    <asp:Label runat="server" ID="lblCustomerPhone"  Text=""></asp:Label>
                                </p>
