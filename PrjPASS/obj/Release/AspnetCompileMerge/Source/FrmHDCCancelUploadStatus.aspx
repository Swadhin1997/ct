<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/PASS.Master" CodeBehind="FrmHDCCancelUploadStatus.aspx.cs" Inherits="ProjectPASS.FrmHDCCancelUploadStatus" %>
    ...
    <div class="smart-wrap">
        <div class="smart-forms smart-container wrap-4">
            <div class="form-header header-blue">
                <h4><i class="fa fa-sign-in"></i>PASS - Cancel Upload Dump(HDC)</h4>
