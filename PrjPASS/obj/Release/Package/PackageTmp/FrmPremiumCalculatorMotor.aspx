<%@ Page Title="" Language="C#" MasterPageFile="~/PASS.Master" AutoEventWireup="true" CodeBehind="FrmPremiumCalculatorMotor.aspx.cs" Inherits="PrjPASS.FrmPremiumCalculatorMotor" %>
    ...
    <script type="text/javascript">
        ...
        function ChangeDORLabel() {
            ...
            if (IsNewBusinessType) {
                ...
                //    //newOption = "<option value='1063'>Kotak Car Secure –Bundled (3+1)</option>"; //CR507 - HASMUKH
                //}
                //else
                //{
                //    //alert('123');
                ...
                if (IsDisable3Plus3) {
                    newOption = "<option value='1063' selected>Kotak Car Secure –Bundled (3+1)</option>"; //CR507 - HASMUKH
                }
                else if (selectedProductType == "1062" && IsDisable3Plus3 == false)
                {
                    newOption = "<option value='1063'>Kotak Car Secure –Bundled (3+1)</option><option value='1062' selected>Kotak Car Secure –3 years (3+3)</option>";
                }
                else
                ...
                var newOption = "<option value='1011'>Kotak Car Secure (1+1)</option>";
                $("#<%=drpProductType.ClientID%>").append(newOption);
        ...
        function SetAutoComplete() {
            ...
            if (IsNewBusinessType) {
                ...
                //var newOption = "<option value='1063'>Kotak Car Secure –Bundled (3+1)</option><option value='1062'>Kotak Car Secure –3 years (3+3)</option>";
                //var newOption = "<option value='1063'>Kotak Car Secure –Bundled (3+1)</option>"; //CR507 - HASMUKH
                var newOption = "";
                if (IsDisable3Plus3) {
                    newOption = "<option value='1063'>Kotak Car Secure –Bundled (3+1)</option>"; //CR507 - HASMUKH
                }
                    ...
                    <div class="form-body theme-blue" style="padding-top: 16px;">
                                            ...
                                            <Content>
                                                ...
                                                <table id="table1" style="width: 100%;" cellspacing="0" cellpadding="2">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <obout:OboutRadioButton GroupName="bt" ID="rbbtNewBusiness" Text="New Business" runat="server" onclick="ChangeDORLabel();" Checked="true" OnCheckedChanged="rbbtNewBusiness_CheckedChanged" AutoPostBack="true"></obout:OboutRadioButton>
                                                            <obout:OboutRadioButton GroupName="bt" ID="rbbtRollOver" Text="Roll Over" runat="server" onclick="ChangeDORLabel();" OnCheckedChanged="rbbtRollOver_CheckedChanged" AutoPostBack="true"></obout:OboutRadioButton>
                                                       ...
                                                       <td class="tdbkg">Product Type
                                                        ...
                                                        <td>
                                                            <asp:DropDownList CssClass="drp" ID="drpProductType" runat="server" EnableViewState="true" style="width: 230px;" AutoPostBack="true" OnSelectedIndexChanged="drpProductType_SelectedIndexChanged">
                                                                ...
                                                                <asp:ListItem Text="Kotak Car Secure (1+1)" Value="1011"></asp:ListItem>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList CssClass="drp" ID="drpVDA" runat="server">
                                                                ...
                                                                <%--<asp:ListItem Text="15000" Value="15000" />   remove CR048--%>
                                                            </asp:DropDownList>
                                                        </td>
                        ...
                        <div class="modal-dialog" style="width:80%;">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                     <asp:Panel ID="pnlTest" runat="server"><div style="text-align: center; display: none; font-size:8px"></div><div style="display: none"><asp:Label runat="server" ID="lblETC" Text="" style="font-size:10px"></asp:Label><table style="font-size: 8px" cellspacing="0" cellpadding="2" border="0"><tr style="background-color:gainsboro;color: dodgerblue;"><td style="font-size:8px">Quote Number</td><td>IMD Code</td><td>Customer Name</td><td>Customer Gender</td></tr>
                                        <tr>
                                       ...
                                       <tr style="background-color:gainsboro;color: dodgerblue;">
                                        ...
                                        <tr>
                                            <td><asp:Label runat="server" ID="lblCNGLPGKitIDV" Text="0"></asp:Label></td>
                                            <td><asp:Label runat="server" ID="lblCustomerEmail" Text="-"></asp:Label></td>
                                            <td><asp:Label runat="server" ID="lblCustomerContactNo" Text="0"></asp:Label></td>
                                            <td></td>
                                        </tr></table></div><table style="font-size:11px" cellspacing="10" width="100%"><tr><td valign="top" style="padding-right:20px">
                                        <table id="table3" style="width: 100%; text-align: left;" cellspacing="0" cellpadding="2" border="1" valign="top">
                                                    ...
                                                    <tr>
                                                        <td>Daily Car Allowance <asp:Label runat="server" ID="lbllblDailyCarAllowanceSI" Text=""></asp:Label></td>
                                                        <td align="right"><asp:Label runat="server" ID="lblDailyCarAllowance" Text="0.00"></asp:Label></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Key Replacement <asp:Label runat="server" ID="lblKeyReplacementSI" Text=""></asp:Label></td>
                                                    ...
                                                    <tr>
                                                        <td>Loss of Personal Belongings <asp:Label runat="server" ID="lblLossofPersonalBelongingsSI" Text=""></asp:Label></td>
