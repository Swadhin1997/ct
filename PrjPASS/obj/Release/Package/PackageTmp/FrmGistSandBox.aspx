<%@ Page Title="" Language="C#" MasterPageFile="~/PASS.Master" AutoEventWireup="true" CodeBehind="FrmGistSandBox.aspx.cs" Inherits="PrjPASS.FrmGistSandBox" %>
                    ...
                    <div class="form-body theme-blue" style="padding-top: 16px;">
                        <div class="frm-row">
                            <div class="section colm colm12">
                                ...
                                <table id="table1" cellspacing="0" cellpadding="2" class="auto-style3">
                                     <tr>
                                                       <td class="auto-style11" colspan="6" style="font-size:15px">CUSTOMER DETAILS
                                                        </td>
                                         </tr>
                                                    <tr>
                                                       <td class="auto-style4">Customer Name
                                                        </td>
                                                        <td class="auto-style9" >
                                                           <obout:OboutTextBox ID="txtCustomerName" runat="server" Text="" CssClass="auto-style11"  style="left: 0px; top: 0px; width: 250px" Width="250"></obout:OboutTextBox>
                                                        </td>

                                                         <td class="auto-style8">Email Address&nbsp;
                                                        </td>
                                                        <td class="auto-style10">
                                                           <obout:OboutTextBox ID="txtEmailId" runat="server" Text="" CssClass="auto-style6" style="left: 0px; top: 0px" Width="250px"></obout:OboutTextBox>
                                                        </td>
                                     ...
                                     <tr>
                                                       <td class="auto-style4">Mobile number
                                                        ...
                                                        <td class="auto-style9">
                                                           <obout:OboutTextBox ID="txtMobNo" runat="server" Text="" Width="250px"></obout:OboutTextBox>
                                                        </td>

                                                         <td class="auto-style8">Product Name
                                                        </td>
                                                        <td class="auto-style10">
                                                           <obout:OboutTextBox ID="txtProductName" runat="server" Text="" Width="250px"></obout:OboutTextBox>
                                                        </td>
                                     ...
                                     <tr>
                                                       <td class="auto-style4">Policy Number
                                                        </td>
                                                        <td class="auto-style9">
                                                           <obout:OboutTextBox ID="txtPolicyNo" runat="server" Text="" Width="250px"></obout:OboutTextBox>
                                                        </td>

                                                        
                                                          <td class="auto-style8">Place
                                                        </td>
                                                        <td class="auto-style10">
                                                            <obout:OboutTextBox ID="txtPlace" runat="server" Text="" Width="250px"></obout:OboutTextBox>
                                                        </td>
                                       ...
                                       <tr>
                                                         ...
                                                         <td class="auto-style4">
                                                             <span>Click to genetarte the link</span>
                                                        </td>
                                                        <td class="auto-style9" colspan="3">
                                                            <obout:OboutButton ID="btnGnrtLink" runat="server" Text="Generate Link" Width="150px" OnClick="btnGnrtLink_Click">
                                                            </obout:OboutButton>
                                                         </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style2" colspan="4">
                                            <a id="lnkGeneratedLinkFull" runat="server"  ></a>
                                         
                                            <a id="lnkGeneratedLinkShort" runat="server"  ></a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style2" colspan="2">
                                            ...
                                            <td class="auto-style2" colspan="1" align="left">
                                          <obout:OboutButton ID="btnSendLink" runat="server" Text="Send Link" Width="150px" OnClick="btnSendLink_Click" >
                                                            </obout:OboutButton>
                                           </td>
                                    </tr>
                                ...
                                <div style="">
                          <asp:Label ID="lblMsg" runat="server" style="color:black" />
                                    </div>
