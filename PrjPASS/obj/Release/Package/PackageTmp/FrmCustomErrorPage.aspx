<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmCustomErrorPage.aspx.cs" Inherits="PrjPASS.FrmCustomErrorPage" %>
                        ...
                        <div class="abs-center">
                            <div class="text-center mv-lg">
                                ...
                                <p class="lead m0" style="font-size: 1.8rem; font-family: Source Sans Pro, sans-serif">
                                    Something technically went wrong or the page has been refreshed.<br />
