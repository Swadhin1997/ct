<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/PASS.Master" CodeBehind="FrmHDCPolicyUploadStatus.aspx.cs" Inherits="PrjPASS.FrmHDCPolicyUploadStatus" %>
    ...
    <div class="smart-wrap">
        <div class="smart-forms smart-container wrap-4">
            <div class="form-header header-blue">
                <h4><i class="fa fa-sign-in"></i>PASS - Policy Upload Dump(HDC)</h4>
                ...
                <div class="frm-row">
                    <div class="section colm colm12">
                        <asp:Panel ID="Panel1" runat="server" Height="150px" BorderColor="#3399ff" BorderWidth="2">
                            ...
                            <img src="images/calendar.png" alt="" id="datepickerFromDate" /> <%--CR 642  Ravi--%>
                            </div>
                            ...
                            <div style="position: absolute; top: 16%; left: 58%; width: 35%; margin-top: 10px; margin-left: 10px">
                             ...
                             <img src="images/calendar.png" alt="" id="datepickerToDate" /> <%--CR 642  Ravi--%>
                            </div>
