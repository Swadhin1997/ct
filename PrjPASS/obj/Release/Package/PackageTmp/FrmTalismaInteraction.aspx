<%@ Page Language="C#" MasterPageFile="~/PASS.Master" AutoEventWireup="true" CodeBehind="FrmTalismaInteraction.aspx.cs" Inherits="PrjPASS.FrmTalismaInteraction" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MstCntFormContent" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
      ...
      <div class="smart-wrap" style= "padding-bottom: 20px;">
                        ...
                        <div class="frm-row">
                            <div class="section colm colm12">
                                <table id="table33" style="width: 100%;" cellspacing="0" cellpadding="2">
                                     <tr>
                                                       <td class="tdbkgHead" colspan="6" style="font-size:15px">Upload Interaction File(Bulk By Scheduler) 
                                                        </td>
                                         </tr>
                                      <tr>
                                                     

                                                         <td class="tdbkg">Upload Excel For Bulk Interaction 
                                                            &nbsp;&nbsp;&nbsp;
                                                             <%--<a id="lnkDownLoadSampleScheduler" href="https://kgipass.kotakmahindrageneralinsurance.co.in/KGIPASS/ExcelTemplate/BulkCreateInvoiceTemplate.xlsx" target="_blank">Download Sample Format</a>--%>
                                                        ...
                                                        <td class="tdbkg" colspan="1" align="right">
                                                            <obout:OboutButton ID="btnUploadInteractonFile" runat="server" Text="Upload Interaction Data File" OnClick="btnUploadInteractonFile_Click" OnClientClick="return ShowProgress();"></obout:OboutButton>
          ...
          <div style="padding-left: 20px;padding-right: 20px;">
           ...
           <div class="section colm colm12">
                                <asp:Panel ID="Panel2" runat="server" BorderColor="#727272" BorderWidth="2" Visible="true">
                                    ...
                                    <div style="position: absolute; left: 42%; width: 10%; margin-top: 10px; margin-left: 10px;">
                                        <asp:Button ID="btnExit" style="width:100%;height: 30px;" runat="server" Text="Exit" OnClick="btnExit_Click"></asp:Button>
                                    </div>
                                </asp:Panel>
                            </div>
    <%--</div>--%>
        ...
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="btnUploadInteractonFile" />
        </Triggers>
        </asp:UpdatePanel>
