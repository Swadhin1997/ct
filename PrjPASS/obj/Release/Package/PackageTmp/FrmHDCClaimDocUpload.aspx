<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/PASS.Master" CodeBehind="FrmHDCClaimDocUpload.aspx.cs" Inherits="PrjPASS.FrmHDCClaimDocUpload" %>
                ...
                <div class="frm-row">
                    <div class="section colm colm12">
                        <asp:Panel ID="Panel1" runat="server" Height="100px" BorderColor="#3399ff" BorderWidth="2">                            
                            ...
                            <asp:HiddenField runat="server" ID="hdnMasterPolicyHolderName" Value="" />
                            <asp:HiddenField runat="server" ID="hdnClaimRegistrationDate" Value="" />
                            <asp:HiddenField runat="server" ID="hdnClaimIntimationDate" Value="" />
                            <asp:HiddenField runat="server" ID="hdnCustomerName" Value="" />
                        </asp:Panel>
                    </div>
                    <div class="section colm colm12">
