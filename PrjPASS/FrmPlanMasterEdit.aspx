<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/PASS.Master" CodeBehind="FrmPlanMasterEdit.aspx.cs" Inherits="ProjectPASS.FrmPlanMasterEdit" %>
                ...
                <div class="frm-row">
                    <div class="section colm colm12">
                        <asp:Panel ID="Panel1" runat="server" Height="250px" BorderColor="#3399ff" BorderWidth="2">
                            ...
                            <asp:HiddenField ID="hdnMasterDate" runat="server" />
                             <div style="position: absolute; top: 1%; left: 1%; width: 35%; margin-top: 10px; margin-left: 10px">                                 
                            <asp:Label ID="lblProduct" runat="server" Text="Product Code" Width="100%"></asp:Label>
                                </div>
                             <div style="position: absolute; top: 1%; left: 20%; width: 35%; margin-top: 10px; margin-left: 10px">                                 
                               <obout:ComboBox ID="cmbProduct" runat="server" Width="57%" OnSelectedIndexChanged="cmbProduct_SelectedIndexChanged" AutoPostBack="true" AllowEdit="false"></obout:ComboBox>
                            </div>

                             <div style="position: absolute; top: 1%; left: 51%; width: 35%; margin-top: 10px; margin-left: 10px">                                 
                            <asp:Label ID="lblProposal" runat="server" Text="Proposal Type" Width="100%"></asp:Label>
                              </div>
                             <div style="position: absolute; top: 1%; left: 65%; width: 35%; margin-top: 10px; margin-left: 10px">                                 
                               <obout:ComboBox ID="cmbProposal" runat="server" Width="57%" AllowEdit="false">                                    
                                    <obout:ComboBoxItem Text="Credit Linked" Value="Credit Linked" />
                                    <obout:ComboBoxItem Text="Non Credit Linked" Value="Non Credit Linked"/>
                                </obout:ComboBox>
                            </div>
                            ...
                            <div style="position: absolute; top: 11%; left: 20%; width: 35%; margin-top: 10px; margin-left: 10px">
                               <obout:Combobox ID="drpPlanList" runat="server" class="input" AutoPostBack="true" Height="100px" OnSelectedIndexChanged="drpPlanList_SelectedIndexChanged" AllowEdit="false"></obout:Combobox>
                            </div>
                            <div style="position: absolute; top: 11%; left: 51%; width: 8%; margin-top: 10px; margin-left: 10px">
                                <asp:Label ID="Label2" runat="server" Text="Plan SI" Width="100%"></asp:Label>
                            </div>
                            <div style="position: absolute; top: 11%; left: 65%; width: 20%; margin-top: 10px; margin-left: 10px">
                            ...
                            <div style="position: absolute; top: 21%; left: 20%; width: 20%; margin-top: 10px; margin-left: 10px">
                                <obout:OboutTextBox ID="txtStampDuty" Style="text-transform: uppercase" Width="100%" runat="server" MaxLength="10"></obout:OboutTextBox>
                            </div>
                            <div style="position: absolute; top: 21%; left: 51%; width: 18%; margin-top: 10px; margin-left: 10px">
                                <asp:Label ID="Label5" runat="server" Text="Section A Premium" Width="100%"></asp:Label>
                            </div>
                            <div style="position: absolute; top: 21%; left: 65%; width: 20%; margin-top: 10px; margin-left: 10px">
                                <obout:OboutTextBox ID="txtSecAPrem" Style="text-transform: uppercase" Width="100%" runat="server" MaxLength="10"></obout:OboutTextBox>
                            </div>
                            <div style="position: absolute; top: 31%; left: 1%; width: 20%; margin-top: 10px; margin-left: 10px">
                                <asp:Label ID="Label6" runat="server" Text="Extension To Section A Premium" Width="100%"></asp:Label>
                            </div>
                            <div style="position: absolute; top: 31%; left: 20%; width: 20%; margin-top: 10px; margin-left: 10px">
                            ...
                            <div style="position: absolute; top: 31%; left: 51%; width: 20%; margin-top: 10px; margin-left: 10px">
                                <asp:Label ID="Label7" runat="server" Text="Section B Premium" Width="100%"></asp:Label>
                            </div>
                            <div style="position: absolute; top: 31%; left: 65%; width: 20%; margin-top: 10px; margin-left: 10px">
                                <obout:OboutTextBox ID="txtSecBPrem" Style="text-transform: uppercase" Width="100%" runat="server" MaxLength="10"></obout:OboutTextBox>
                            </div>

                             <div style="position: absolute; top: 41%; left: 1%; width: 20%; margin-top: 10px; margin-left: 10px">
                                <asp:Label ID="lblSIBasis" runat="server" Text="Sum Insured Basis" Width="100%"></asp:Label>
                            </div>
                            <div style="position: absolute; top: 41%; left: 20%; width: 20%; margin-top: 10px; margin-left: 10px">
                                <obout:ComboBox ID="cmbSIBasis" runat="server" Width="57%" AllowEdit="false">
                                     <obout:ComboBoxItem Text="Fixed" Value="Fixed"/>
                                    <obout:ComboBoxItem Text="Reducing" Value="Reducing"/>
                                </obout:ComboBox>
                            </div>

                             <div style="position: absolute; top: 41%; left: 51%; width: 20%; margin-top: 10px; margin-left: 10px">
                                <asp:Label ID="lblFinancer" runat="server" Text="Financer Name" Width="100%"></asp:Label>
                            </div>
                            <div style="position: absolute; top: 41%; left: 65%; width: 20%; margin-top: 10px; margin-left: 10px">
                                <obout:OboutTextBox ID="txtFinancer" Style="text-transform: uppercase" Width="100%" runat="server" MaxLength="100"></obout:OboutTextBox>
                            </div>

                             <div style="position: absolute; top: 51%; left: 1%; width: 20%; margin-top: 10px; margin-left: 10px">
                                <asp:Label ID="Label8" runat="server" Text="Master Policy No." Width="100%"></asp:Label>
                            </div>
                            <div style="position: absolute; top: 51%; left: 20%; width: 20%; margin-top: 10px; margin-left: 10px">
                                <obout:OboutTextBox ID="txtMasterPolicyNo" Style="text-transform: uppercase" Width="100%" runat="server" MaxLength="100"></obout:OboutTextBox>
                            </div>

                              <div style="position: absolute; top: 51%; left: 51%; width: 20%; margin-top: 10px; margin-left: 10px">
                                <asp:Label ID="Label9" runat="server" Text="Master Policy Issue Date" Width="100%"></asp:Label>
                            </div>
                            <div style="position: absolute; top: 51%; left: 65%; width: 20%; margin-top: 10px; margin-left: 10px">
                               ...
                               <div style="position: absolute; top: 61%; left: 1%; width: 20%; margin-top: 10px; margin-left: 10px">
                                <asp:Label ID="lblMasterPolicyLoc" runat="server" Text="Master Policy Location" Width="100%"></asp:Label>
                            </div>
                            <div style="position: absolute; top: 61%; left: 20%; width: 20%; margin-top: 10px; margin-left: 10px">
                                <obout:OboutTextBox ID="txtMasterPolicyLoc" Style="text-transform: uppercase" Width="100%" runat="server" MaxLength="100"></obout:OboutTextBox>
                            </div>

                            <div style="position: absolute; top: 61%; left: 51%; width: 20%; margin-top: 10px; margin-left: 10px">
                                <asp:Label ID="lblLoanType" runat="server" Text="Loan Type" Width="100%"></asp:Label>
                            </div>
                            <div style="position: absolute; top: 61%; left: 65%; width: 20%; margin-top: 10px; margin-left: 10px">
                                <obout:OboutTextBox ID="txtLoanType" Style="text-transform: uppercase" Width="100%" runat="server" MaxLength="100"></obout:OboutTextBox>
                            </div>

                             <div style="position: absolute; top: 71%; left: 1%; width: 20%; margin-top: 10px; margin-left: 10px">
                                <asp:Label ID="lblMinPolicyTenure" runat="server" Text="Min Policy Tenure" Width="100%"></asp:Label>
                            </div>
                            <div style="position: absolute; top: 71%; left: 20%; width: 20%; margin-top: 10px; margin-left: 10px">
                                <obout:OboutTextBox ID="txtMinPolicyTenure" Style="text-transform: uppercase" Width="100%" runat="server" MaxLength="1" OnTextChanged="txtMinPolicyTenure_TextChanged" AutoPostBack="true"></obout:OboutTextBox>
                            </div>

                            <div style="position: absolute; top: 71%; left: 51%; width: 20%; margin-top: 10px; margin-left: 10px">
                                <asp:Label ID="lblMaxPolicyTenure" runat="server" Text="Max Policy Tenure" Width="100%"></asp:Label>
                            </div>
                            <div style="position: absolute; top: 71%; left: 65%; width: 20%; margin-top: 10px; margin-left: 10px">
                                <obout:OboutTextBox ID="txtMaxPolicyTenure" Style="text-transform: uppercase" Width="100%" runat="server" MaxLength="1" OnTextChanged="txtMaxPolicyTenure_TextChanged" AutoPostBack="true"></obout:OboutTextBox>
                            </div>
