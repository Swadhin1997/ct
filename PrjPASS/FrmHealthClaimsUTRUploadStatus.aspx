<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/PASS.Master" CodeBehind="FrmHealthClaimsUTRUploadStatus.aspx.cs" Inherits="PrjPASS.FrmHealthClaimsUTRUploadStatus" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="MstCntFormContent">
    <div class="smart-wrap">
        <div class="smart-forms smart-container wrap-4">
            <div class="form-header header-blue">
                <h4><i class="fa fa-sign-in"></i>PASS - Health Claims Upload UTR Status Dump</h4>
    ...
    <script type="text/javascript">
        function validateFilters() {
            debugger;
            if ($('#ctl00_MstCntFormContent_txtFromDate').val().trim() == '' && $('#ctl00_MstCntFormContent_txtToDate').val().trim() == '' && $('#ctl00_MstCntFormContent_txtClaimNumber').val().trim() == '' && $('#ctl00_MstCntFormContent_txtUploadId').val().trim() == '') {
