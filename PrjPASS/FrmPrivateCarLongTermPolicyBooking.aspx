<%@ Page Title="PASS - Kotak Car Secure (Bundled)" Language="C#" MasterPageFile="~/PASS.Master" AutoEventWireup="true" CodeBehind="FrmPrivateCarLongTermPolicyBooking.aspx.cs" Inherits="PrjPASS.FrmPrivateCarLongTermPolicyBooking" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //Sys.WebForms.PageRequestManager.getInstance().add_endRequest(openModalCreatePolicy);
        });
        ...
        function openModalCreatePolicy() {
            $('#modalCreatePolicy').modal('show');
        }

        function CloseModalCreatePolicy() {
            $('#modalCreatePolicy').modal('hide');
        }
        
        function openModalSavePolicySuccess() {
            $('#modalSavePolicySuccess').modal('show');
        }

        function CloseModalSavePolicySuccess() {
            $('#modalSavePolicySuccess').modal('hide');
        }
        ...
        function SetAutoComplete() {
            ...
            $("[id$=txtFinancierName]").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/FrmPrivateCarLongTermPolicyBooking.aspx/GetFinacier") %>',
            ...
            $("[id$=txtRTOAuthorityCode]").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/FrmPrivateCarLongTermPolicyBooking.aspx/GetRTO") %>',
                        data: "{ 'prefix': '" + request.term + "'}",
                        dataType: "json",
                        type: "POST",                      
                        contentType: "application/json; charset=utf-8",
            ...
            $("[id$=txtIntermediaryName]").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/FrmPrivateCarLongTermPolicyBooking.aspx/GetIntermediaryCode") %>',
                        data: "{ 'prefix': '" + request.term + "'}",
                        dataType: "json",
                        type: "POST",                      
                        contentType: "application/json; charset=utf-8",
            ...
            $("[id$=txtPinCode]").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/FrmPrivateCarLongTermPolicyBooking.aspx/GetPincode") %>',
                        data: "{ 'prefix': '" + request.term + "'}",
                        dataType: "json",
                        type: "POST",                      
                        contentType: "application/json; charset=utf-8",
            ...
            if (IsNewBusinessType) {
                var dy = d_minDate.getFullYear();
                dy = dy - 0; // erlier substracting 1, now 0
                var oyd = '01/01/' + dy;
                d_minDate = new Date(oyd);
            }
            else
            ...
            var d_maxDate = new Date();
            var dy = d_maxDate.getFullYear();
            dy = dy + 1; //Commented for not allowing future dates
            d_maxDate.setYear(dy);
...
<asp:Content ID="Content1" ContentPlaceHolderID="MstCntFormContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:HiddenField ID="hdnCustomerType" Value="I" runat="server" />
            <asp:HiddenField ID="hdnCustomerId" Value="" runat="server" />
            <asp:HiddenField ID="hdnCustomerStateCode" Value="" runat="server" />
            <asp:HiddenField ID="hdnNetPremium" Value="0" runat="server" />
            <asp:HiddenField ID="hdnTotalPremium" Value="0" runat="server" />

            <asp:HiddenField ID="hdnIMDMobileNumber" Value="" runat="server" />
            <asp:HiddenField ID="hdnIMDTelePhoneNumber" Value="" runat="server" />

            <asp:HiddenField ID="hdnIsIGSTApplicable" Value="0" runat="server" />
            <asp:HiddenField ID="hdnIGSTPercent" Value="" runat="server" />
            <asp:HiddenField ID="hdnIGSTAmount" Value="" runat="server" />

            <asp:HiddenField ID="hdnIsCGSTApplicable" Value="0" runat="server" />
            <asp:HiddenField ID="hdnCGSTPercent" Value="" runat="server" />
            <asp:HiddenField ID="hdnCGSTAmount" Value="" runat="server" />

            <asp:HiddenField ID="hdnIsSGSTApplicable" Value="0" runat="server" />
            <asp:HiddenField ID="hdnSGSTPercent" Value="" runat="server" />
            <asp:HiddenField ID="hdnSGSTAmount" Value="" runat="server" />

            <asp:HiddenField ID="hdnIsUGSTApplicable" Value="0" runat="server" />
            <asp:HiddenField ID="hdnUGSTPercent" Value="" runat="server" />
            <asp:HiddenField ID="hdnUGSTAmount" Value="" runat="server" />

            <asp:HiddenField ID="hdnCustomerFullNameWithTitle" Value="" runat="server" />
            <asp:HiddenField ID="hdnCustomerAddressLine123" Value="" runat="server" />
            <asp:HiddenField ID="hdnCustomerCity" Value="" runat="server" />
            <asp:HiddenField ID="hdnCustomerPincode" Value="" runat="server" />
            <asp:HiddenField ID="hdnCustomerDistrict" Value="" runat="server" />
            <asp:HiddenField ID="hdnCustomerState" Value="" runat="server" />
            <asp:HiddenField ID="hdnCustomerMobileNumber" Value="" runat="server" />
            <asp:HiddenField ID="hdnCustomerPhoneNumber" Value="" runat="server" />
            <asp:HiddenField ID="hdnCustomerEmailAddress" Value="" runat="server" />
            <asp:HiddenField ID="hdnCustGSTIN" Value="" runat="server" />
            <asp:HiddenField ID="hdnCustGSTIdentifier" Value="" runat="server" />

            <asp:HiddenField ID="hdnPolicyIssuingOffice" Value="" runat="server" />
            <asp:HiddenField ID="hdnOfficeGSTNumber" Value="" runat="server" />

            <asp:HiddenField ID="hdnEnabledAddOnsName" runat="server" Value="" />

            <div class="modal fade" id="modalSavePolicySuccess" role="dialog" data-backdrop="static" style="margin-top:-17px">
                        <div class="modal-dialog" style="width:80%;">
                            ...
                            <div class="modal-content">
                                <div class="modal-header alert alert-info fade in">
                                    ...
                                    <h4 class="modal-title">Policy Creation Successfull</h4>
                                </div>
                                <div class="modal-body">
                                  ...
                                  <div style="float:left;width: 600px;text-align: left;"> 
                                    ...
                                    <br />
                                    <table id="table27" style="width: 100%; text-align: left;" cellspacing="0" cellpadding="2" border="1" valign="top">
                                           <tr style="text-align: left; background-color: gray; color: white;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label ID="lblCustomerFullName2" runat="server"></asp:Label>
                                                </td>
                                                <td>
                                        ...
                                        <tr style="text-align: left; background-color: gray; color: white;">
                                                <td style="color:white" colspan="3">Policy Details</td>
                                           </tr>
                                            <tr style="background-color:rgba(128, 128, 128, 0.18);font-weight:bold;">
                                                <td>Quote Number</td>
                                                <td>Policy Number</td>
                                         ...
                                         <tr style="background-color:rgba(128, 128, 128, 0.18);font-weight:bold;">
                                                <td>Own Damage Policy Start Date</td>
                                                <td>Own Damage Policy End Date</td>
                                                <td></td>
                                            </tr>

                                        <tr>
                                                <td>
                                                    <asp:Label ID="lblOwnDamagePolicyStartDateTime" runat="server"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="lblOwnDamagePolicyEndDateTime" runat="server"></asp:Label> Midnight
                                                </td>
                                                <td>
                                         ...
                                         <tr style="background-color:rgba(128, 128, 128, 0.18);font-weight:bold;">
                                                <td>Liability Policy Start Date</td>
                                                <td>Liability Policy End Date</td>
                                                <td></td>
                                            </tr>

                                           <tr>
                                                <td>
                                                    <asp:Label ID="lblLiabilityPolicyStartDateTime" runat="server"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="lblLiabilityPolicyEndDateTime" runat="server"></asp:Label> Midnight
                                                </td>
                                                <td>
                                        ...
                                        <tr>
                                                ...
                                                <td>
                                                    <asp:Label ID="lblInwardNumber" runat="server">-</asp:Label>
                                                </td>
                                                <td>
                                                </td>
                                            </tr>
                                        <tr id="trEmailIdAndRemarksRow" runat="server">
                                            <td colspan="3">
                                            <asp:Button ID="btnDownloadPolicyPDF" class="btn btn-info" runat="server" Text="Download Policy Schedule" OnClick="btnDownloadPolicyPDF_Click" />
                                            <asp:Button ID="btnDownloadPolicyPDFPrintCopy" class="btn btn-info" runat="server" Text="Download Policy Schedule Print Copy" OnClick="btnDownloadPolicyPDFPrintCopy_Click" />
                                            <button type="button" class="btn btn-primary" data-dismiss="modal" id="btnCloseSuccessProposalPopup" name="btnCloseSuccessProposalPopup">Close</button>
                                                </td>
                                        </tr>
                                    </table>
                                </div>
            ...
            <div class="modal fade" id="modalCreatePolicy" role="dialog" data-backdrop="static" style="margin-top:-17px">
                        <div class="modal-dialog" style="width:80%;">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <at1:Accordion
                                    ...
                                    <Panes>
                                        <at1:AccordionPane ID="AccordionPane5" runat="server" HeaderCssClass="accordionHeader"
                                            HeaderSelectedCssClass="accordionHeaderSelected"
                                            ContentCssClass="accordionContent">
                                            <Header>Search Customer</Header>
                                            <Content>
                                                 <table id="table24" style="width: 100%;" cellspacing="0" cellpadding="2">
                                                     <tr>
                                                         <td class="tdbkg">Enter GIST Customer Id</td>
                                                         <td>
                                                             <asp:TextBox ID="txtSearchCustomerId" runat="server" BorderStyle="Solid" BorderColor="Black" BorderWidth="1px" MaxLength="12"></asp:TextBox>
                                                         </td>
                                                         <td>
                                                             <obout:OboutButton ID="btnSearchCustomer" runat="server" Text="Search Customer" OnClick="btnSearchCustomer_Click" OnClientClick="CloseModalCreatePolicy();"></obout:OboutButton>
                                                         </td>
                                                     </tr>
                                                 </table>
                                            </Content>
                                                ...
                                                <table id="table21" style="width: 100%;" cellspacing="0" cellpadding="2">
                                                    ...
                                                    <tr id="trCustomerRow1">
                                                      ...
                                                      <tr id="trCustomerRow3">
                                                        ...
                                                        <td>
                                                           <asp:Label ID="lblCustomerEMailId" runat="server" Text=""></asp:Label>
                                                        </td>
                                                        ...
                                                        <td>
                                                           <asp:Label ID="lblCustomerMobileNumber" runat="server" Text=""></asp:Label>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                       <td class="tdbkg">Registration Number
                                                        ...
                                                        <td>
                                                            ...
                                                            <obout:OboutTextBox ID="txtRN3" runat="server" Text="" MaxLength="3" Width="42px"></obout:OboutTextBox>
                                                            <obout:OboutTextBox ID="txtRN4" runat="server" Text="" MaxLength="4" Width="60px"></obout:OboutTextBox>
                                                        </td>
                                        ...
                                        <at1:AccordionPane ID="AccordionPane4" runat="server" HeaderCssClass="accordionHeader"
                                         ...
                                         <at1:AccordionPane ID="AccordionPane6" runat="server" HeaderCssClass="accordionHeader"
                                            HeaderSelectedCssClass="accordionHeaderSelected"
                                            ContentCssClass="accordionContent">
                                            <Header>Receipt Details</Header>
                                            <Content>
                                                 <table id="table30" style="width: 100%;" cellspacing="0" cellpadding="2">
                                                    <tr>
                                                       <td class="tdbkg">GIST Receipt Number
                                                        </td>
                                                        <td>
                                                            <obout:OboutTextBox ID="txtReceiptNumber" runat="server" Text="" MaxLength="15"></obout:OboutTextBox>                                                          
                                                        </td>
                                                    </tr>
                                                     <tr>
                                                       <td class="tdbkg">GIST Inward Id
                                                        </td>
                                                        <td>
                                                            <obout:OboutTextBox ID="txtInwardId" runat="server" Text="" MaxLength="20"></obout:OboutTextBox>                                                          
                                                        </td>
                                                    </tr>
                                                 </table>
                                            </Content>
                                ...
                                <div class="modal-footer">
                                    <div style="float:left;width: 600px;text-align: left;"> 
                                       <asp:Label ID="lblValidationMsg" runat="server" style="color:#054271"></asp:Label>
                                    </div>
                                    <asp:Button ID="btnCreatePolicy" Visible="false" class="btn btn-primary" runat="server" Text="Create Policy" OnClientClick="CloseModalCreatePolicy();" OnClick="btnCreatePolicy_Click" />
                                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                </div>
                            </div>
            ...
            <div class="smart-wrap">
                <div class="smart-forms smart-container wrap-4" id="divSmartContainer" style="margin-top: -115px; margin-bottom: 16px">
                    <div class="form-header header-blue">
                        <h4><i class="fa fa-sign-in"></i>PASS - Private Car (Bundled) Premium Calculator</h4>
                    ...
                    <div class="form-body theme-blue" style="padding-top: 16px;">
                                ...
                                <at1:Accordion
                                    ...
                                    <Panes>
                                                ...
                                                <table id="table1" style="width: 100%;" cellspacing="0" cellpadding="2">
                                                    <tr>
                                                       <td class="tdbkg">Product Type
                                                        ...
                                                        <td>
                                                            <asp:DropDownList CssClass="drp" ID="drpProductType" runat="server">
                                                                <asp:ListItem Text="Select" Value="0"></asp:ListItem>
                                                                <%--<asp:ListItem Text="1+3 - Comprehensive Policy" Value="1+3 - Comprehensive Policy"></asp:ListItem>--%>
                                                                <asp:ListItem Text="3+3 - Comprehensive Policy" Value="3+3 - Comprehensive Policy"></asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList CssClass="drp" ID="drpPolicyHolderType" runat="server">
                                                                <asp:ListItem Text="Select" Value="0"></asp:ListItem>
                                                        ...
                                                        <td>
                                                            <obout:OboutRadioButton GroupName="bt" ID="rbbtNewBusiness" Text="New Business" runat="server" onclick="ChangeDORLabel();" Checked="true"></obout:OboutRadioButton>
                                                            <obout:OboutRadioButton GroupName="bt" ID="rbbtRollOver" Text="Roll Over" runat="server" onclick="" Enabled="false" Visible="false"></obout:OboutRadioButton>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <obout:OboutRadioButton GroupName="ct" ID="rbctIndividual" Text="Individual" runat="server" Checked="true"></obout:OboutRadioButton>
                                                            <obout:OboutRadioButton GroupName="ct" ID="rbctOrganization" Text="Organization" runat="server"></obout:OboutRadioButton>
                                                        </td>
                                                    ...
                                                    <tr>
                                                       ...
                                                       <%--<td class="tdbkg">Vehicle Age
                                                        ...
                                                        <td class="tdbkg">Market Movement
                                                        </td>
                                                        <td>
                                        ...
                                        <at1:AccordionPane ID="accPPD" runat="server" HeaderCssClass="accordionHeader"
                                            HeaderSelectedCssClass="accordionHeaderSelected"
                                            ContentCssClass="accordionContent" Visible="false">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList CssClass="drp" ID="drpCoverType" runat="server" AllowEdit="false">
                                                                <asp:ListItem Text="Comprehensive Policy" Value="ComprehensivePolicy" Selected="true" />
                                                                <asp:ListItem Text="Liability Only Policy" Value="LiabilityOnlyPolicy" />
                                                            </asp:DropDownList>
                                                        </td>
                                        ...
                                        <at1:AccordionPane ID="accCD" runat="server" HeaderCssClass="accordionHeader"
                                            HeaderSelectedCssClass="accordionHeaderSelected"
                                            ContentCssClass="accordionContent">
                                        ...
                                        <at1:AccordionPane ID="accCreditScore" runat="server" HeaderCssClass="accordionHeader"
                                            ...
                                            <Content>
                                                <table id="table25" style="width: 100%;" cellspacing="0" cellpadding="2">
                                                     ...
                                                     <tr>
                                                         <td colspan="6" style="background:lightgray"><obout:OboutCheckBox AutoPostBack="true" ID="chkIsGetCreditScore" runat="server" Text="Get Credit Score" OnCheckedChanged="chkIsGetCreditScore_CheckedChanged"></obout:OboutCheckBox>
                                                        </td>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td>
                                                            <obout:OboutTextBox ID="txtFirstName" runat="server" Enabled="false"></obout:OboutTextBox>
                                                        </td>
                                                        <td class="tdbkg">Customer Middle Name</td>
                                                        <td>
                                                            <obout:OboutTextBox ID="txtMiddleName" runat="server" Enabled="false"></obout:OboutTextBox>
                                                        </td>
                                                         <td class="tdbkg">Customer Last Name</td>
                                                        <td>
                                                            <obout:OboutTextBox ID="txtLastName" runat="server" Enabled="false"></obout:OboutTextBox>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr><td class="tdbkg">Gender
                                                        ...
                                                        <td>
                                                           ...
                                                           <td class="tdbkg">
                                                               <obout:OboutDropDownList ID="drpDrivingLicenseNumberOrAadhaarNumber" runat="server" Enabled="false">
                                                        ...
                                                        <td>
                                                            <obout:OboutTextBox Enabled="false" ID="txtDrivingLicenseNumberOrAadhaarNumber" runat="server" placeholder="enter pan number"></obout:OboutTextBox>
                                                        </td>
                                                        </td>

                                                         <td class="tdbkg">Customer Phone Number
                                                             
                                                        </td>
                                                        <td>
                                                             <obout:OboutTextBox ID="txtMobileNumber" runat="server" Enabled="false"></obout:OboutTextBox>
                                                        </td>
                                                     ...
                                                     <tr><td class="tdbkg">Customer DOB
                                                        ...
                                                        <td>
                                                            <obout:OboutTextBox ID="txtCustomerDOB" runat="server" ReadOnly="false" Enabled="false"></obout:OboutTextBox>
                                                        ...
                                                        <td>
                                                            <obout:OboutTextBox ID="txtPinCode" runat="server" Enabled="false"></obout:OboutTextBox>
                                ...
                                <asp:Panel ID="Panel2" runat="server" BorderColor="#727272" BorderWidth="2">
                                    <div style="position: absolute; top: 40%; left: 40%; width: 10%; margin-top: 10px; margin-left: 10px">
                                        <obout:OboutButton ID="btnViewPremium" runat="server" Text="View Premium" Width="100%"
                                            OnClick="btnViewPremium_Click" OnClientClick="Reset();" />
                                    </div>
                        ...
                        <div class="modal-dialog" style="width:80%;">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                     <asp:Panel ID="pnlTest" runat="server"><div style="text-align: center; display: none; font-size:9px"></div><div style="display: none"><asp:Label runat="server" ID="lblETC" Text="" style="font-size:10px"></asp:Label>
                                        <table style="font-size: 8px" cellspacing="0" cellpadding="2" border="0"><tr style="background-color:gainsboro;color: dodgerblue;">
                                       ...
                                       <tr style="background-color:gainsboro;color: dodgerblue;">
                                        ...
                                        <table id="table3" style="width: 100%; text-align: left;" cellspacing="0" cellpadding="2" border="1" valign="top">
                                                    <tr style="text-align: center; background-color: gray; color: white;">
                                                        <td style="color:white">OWN DAMAGE (<asp:Label runat="server" ID="lblYearText" Text="1 Year"></asp:Label>)</td>
                                                    ...
                                                    <tr style="text-align: center; background-color: gray; color: white;">
                                                        <td style="color:white">LIABILITY (3 Years)</td>
                                                        <td style="color:white">Premium</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td>PA Cover For Owner Driver</td>
                                         ...
                                         <div style="font-size:7px; display:none;line-height:8px;text-align:left;"><span style="text-align:left">Disclaimer:</span>
                                             <ul>
        ...
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="btnDownloadPolicyPDF" />
            <asp:PostBackTrigger ControlID="btnDownloadPolicyPDFPrintCopy" />
