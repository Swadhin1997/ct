<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmErrorPage.aspx.cs" Inherits="PrjPASS.FrmErrorPage" %>
            ...
            <section>
                    ...
                    <div class="abs-center">
                        <div class="text-center mv-lg">
                            <div class="text-bold text-lg mb-lg" style="font-size: 5rem; font-family: Source Sans Pro, sans-serif; color: #ab9d7e; padding-bottom: 10px">Unknown Error Occurred</div>
                            <p class="lead m0" style="font-size: 1.8rem; font-family: Source Sans Pro, sans-serif">
                                Your payment has been successfully received. But the transaction was not completed due to some technical error. 
                            <br />
                                Please contact Customer Care at Toll Free No. 1800 266 4545 or write us at care@kotak.com
                            <br />
                                <br />
                ...
                <div class="content-wrapper" id="divFailure" runat="server" visible="false">
                    <div class="abs-center">
                        <div class="text-center mv-lg">
                            ...
                            <br />
                                Kindly re-attempt payment or contact Customer Care at Toll Free No. 1800 266 4545 or write us at care@kotak.com
                            <br />
                                <br />
                                <strong>Proposal Id: </strong>
