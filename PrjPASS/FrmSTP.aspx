<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmSTP.aspx.cs" Inherits="PrjPASS.FrmSTP" MaintainScrollPositionOnPostback="true" %>
        ...
        <div class="wrapper">
                                    ...
                                    <div class="panel panel-primary">
                                        <div class="panel-heading bb" style="text-align: center; background-color: #122858fc">
                                            <h4 class="panel-title" style="font-weight: normal;">Deductible 
                                                ...
                                                lacs | 
                                                <strong>Sum Insured
                                                <asp:Label ID="lblSumInsured1" runat="server" Text="0.00"></asp:Label>
                                                    lacs
                                                </strong>|
                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="text-right text-bold">
                                                            &#x20b9;
                                                        <asp:Label ID="lblAnnualAmountPayable1" runat="server" Text="0.00"></asp:Label>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="lblMonthlyAmountPayableType1" runat="server" Text=""></asp:Label>
                                                    </td>
                                                    <td>
                                                        <div class="text-right text-bold">
                                                            &#x20b9;
                                        ...
                                        <div style="text-align: center; margin-bottom: 10px;">
                                            <div class="panel-body" style="padding: 5px;">
                                                <label class="radio-inline c-radio">
                                                    ...
                                                    <span class="fa fa-check"></span>Select this Plan</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel panel-info">
                                        <div class="panel-heading bb" style="text-align: center; background-color: #d20f0f">
                                            <h4 class="panel-title" style="font-weight: normal;">Deductible 
                                                ...
                                                lacs | 
                                               <strong>Sum Insured
                                                <asp:Label ID="lblSumInsured2" runat="server" Text="0.00"></asp:Label>
                                                   lacs
                                               </strong>|
                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <asp:Label runat="server" ID="lblPremiumType2" Text=""></asp:Label>
                                                    </td>
                                                    <td>
                                                        <div class="text-right text-bold">
                                                            &#x20b9;
                                                        <asp:Label ID="lblAnnualAmountPayable2" runat="server" Text="0.00"></asp:Label>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="lblMonthlyAmountPayableType2" runat="server" Text=""></asp:Label>
                                                    </td>
                                                    <td>
                                                        <div class="text-right text-bold">
                                                            &#x20b9;
            ...
            <div class="popUpcontent">
                ...
                <p id="term_NonKLT" runat="server" style="color: black; font-size: 1.3rem; text-align: left; font-style: italic; padding: 50px">
                    ...
                    <a class="link-red callPopup" data-popupname="termsCondition2" target="_self" href="javascript:;">terms & conditions</a>--%>
                    <strong>By clicking on the above button, you hereby give your consent to debit your salary account for the above mentioned amount on a monthly basis towards Kotak Health Super Top Up policy and agree to the <a data-popupname="termsCondition2" class="callPopup" style="color: black" target="_self" href="javascript:;"><u>terms & conditions </u></a></strong>
                </p>
            </section>
            ...
            $(function () {
                ...
                $('#btnMobileVerify').click(function () {
                    ...
                    $('#divTabContent1').children('.tab-pane').each(function () {
                        ...
                        MembersDetails = { UniqueRowId: innerDivMemberId, ReleationshipWithEmployee: innerDivName, Height: Height, Weight: Weight, NomineeName: NomineeName, NomineeDOB: NomineeDOB, EmployeeCode: EmployeeCD, MemberTitle: Title, MemberNomineeRelationWithProposer: NomineeRelationWithProposer };
                    ...
                    var SelectedPlanName = 'PlanB';
                    var IsPlan1Checked = $('#radioPlan1').is(':checked');
                    if (IsPlan1Checked) {
                        SelectedPlanName = 'PlanA';
                    }
                ...
                function SubmitEmployeePrimaryData(objEmployeePrimaryDetails, dataMembersDetails) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "FrmSTP.aspx/SaveEmployeePrimaryDetails",
                ...
                function SubmitMemberData(dataMembersDetails) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "FrmSTP.aspx/SaveMemberDetails",
                ...
                function ShowOTP() {
                    ...
                    if (txtAlternateMobileNumber.value.match(phoneno)) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "FrmSTP.aspx/GenerateOTPNew",
                ...
                $('input[type=radio][name=radioPlanType]').change(function () {
                    ...
                    //if (IsPlan1Checked && IsKLTEmployee == "true")
                    if (IsPlan1Checked) {
                        var lblTotalAmountPayable1 = $("#lblTotalAmountPayable1").text();
                        $("#lblSelectedPremium").text(lblTotalAmountPayable1);
                    }
                    //else if (IsPlan1Checked && IsKLTEmployee == "false") {
                    //    var lblMonthlyAmountPayable1 = $("#lblMonthlyAmountPayable1").text();
                    //    $("#lblSelectedPremium").text(lblMonthlyAmountPayable1);
                    //}
                    ...
                    //else if (!IsPlan1Checked && IsKLTEmployee == "false") {
                    //    var lblMonthlyAmountPayable2 = $("#lblMonthlyAmountPayable2").text();
                    //    $("#lblSelectedPremium").text(lblMonthlyAmountPayable2);
                    //}
                });
