                                     ...
                                     <tr>
                                                       <td class="tdbkg">Validation Period (In Days)
                                                        ...
                                                        <td>
                                                          ...
                                                          <td class="tdbkg">
                                                              <span style="display:none;">Is Send PayU SMS</span>
                                                        </td>
                                                        <td>
                                                            <obout:OboutCheckBox ID="chkSendPayUSMS" runat="server" Visible="false"></obout:OboutCheckBox>
                                                        </td>
                                       ...
                                       <tr style="display:none">
                                            ...
                                            <td class="tdbkg">
                                                             <span style="display:none;">Is Send PayU Email</span>
                                                        </td>
                                                        <td>
                                                            <obout:OboutCheckBox ID="chkSendPayUEmail" runat="server" Visible="false"></obout:OboutCheckBox>
                                                        </td>
                                     ...
                                     <tr>
                                      ...
                                      <tr>
                                                         ...
                                                         <td class="tdbkg">Upload Excel For Bulk Invoice Links 
                                                            &nbsp;&nbsp;&nbsp;
                                                             <a id="lnkDownLoadSampleScheduler" href="https://kgipass.kotakgeneralinsurance.com/KGIPASS/ExcelTemplate/BulkCreateInvoiceTemplate.xlsx" target="_blank">Download Sample Format</a>
                              ...
                              <table id="table31" style="width: 100%;" cellspacing="0" cellpadding="2">
                                     <tr>
                                      ...
                                      <tr>
                                                         ...
                                                         <td class="tdbkg">Upload Excel For Bulk Invoice Links 
                                                            &nbsp;&nbsp;&nbsp;
                                                             <a id="lnkDownLoadSample" href="https://kgipass.kotakgeneralinsurance.com/KGIPASS/ExcelTemplate/BulkCreateInvoiceTemplate.xlsx" target="_blank">Download Sample Format</a>
                                ...
                                <table id="table32" style="width: 100%;" cellspacing="0" cellpadding="2">
                                    ...
                                    <tr>
                                        <td class="tdbkg">
                                            <asp:GridView ID="QuoteGridView" runat="server" AutoGenerateColumns="false" ItemType="ProjectPASS.PayUSavedDetails"
