...
namespace PrjPASS
{
    ...
    public class ITextEvents : PdfPageEventHelper
    {
        ...
        public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            Phrase p1Header = new Phrase("Kotak Mahindra General Insurance", baseFontNormal);
            ...
            //Add paging to footer
            {
                ...
                Paragraph footer1 = new Paragraph("Kotak Mahindra General Insurance Company Ltd. (Formerly Kotak Mahindra General Insurance Ltd.)", FontFactory.GetFont(FontFactory.TIMES, 7, iTextSharp.text.Font.BOLD));
                ...
                footerTbl1.WriteSelectedRows(0, -1, 160, 45, writer.DirectContent);
            ...
            PdfPCell pdfCell5 = new PdfPCell(new Phrase("Quote Date:" + CommonExtensions.GetFormattedDate(PrintTime), baseFontBig));
            PdfPCell pdfCell6 = new PdfPCell(new Phrase("Private Car Premium", baseFontNormal));
