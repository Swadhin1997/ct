<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/PASS.Master" CodeBehind="FrmOutBoundUpload.aspx.cs" Inherits="ProjectPASS.FrmOutBoundUpload" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="MstCntFormContent">
    <div class="smart-wrap">
        <div class="smart-forms smart-container wrap-4">
            <div class="form-header header-blue">
                <h4><i class="fa fa-sign-in"></i>PASS - Outbound Upload</h4>
    ...
    <asp:HiddenField id="hfUploadId" runat="server" Value=""/>
</asp:Content>
